  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="mb-5 rounded-md border border-gold-500/30 bg-gold-500/5 px-3 py-2 text-xs leading-relaxed text-gold-200/85">
          {t("mods.steamWishlist.runtimeDependencyNotice", {
            defaultValue:
              "Workshop installation only installs the selected Workshop item. Mods that require UE4SS need the current UE4SS Experimental (Palworld) installed from Steam Workshop. Mods that require PalSchema additionally need PalSchema installed from Steam Workshop.",
          })}
        </div>
